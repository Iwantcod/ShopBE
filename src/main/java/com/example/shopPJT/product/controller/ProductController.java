...
public class ProductController {
    ...
    public ResponseEntity<?> getProductLatest(@PathVariable String categoryName, @PathVariable int startOffset) {
    ...
    public ResponseEntity<?> getProductPopular(@PathVariable String categoryName, @PathVariable int startOffset) {
    ...
    public ResponseEntity<?> getProductLowestPrice(@PathVariable String categoryName, @PathVariable int startOffset) {
    ...
    public ResponseEntity<?> getProductHighestPrice(@PathVariable String categoryName, @PathVariable int startOffset) {
    ...
    public ResponseEntity<?> addProduct(@ModelAttribute ReqProductDto reqProductDto) throws IOException {
    ...
    public ResponseEntity<?> offProduct(@PathVariable Long productId) {
    ...
    public ResponseEntity<?> updateProduct(@PathVariable Long productId, @ModelAttribute ReqUpdateProductInfoDto reqUpdateProductInfoDto) throws IOException {
    ...
    public ResponseEntity<?> increaseProductInven(@PathVariable Long productId, @PathVariable Integer quantity) {
